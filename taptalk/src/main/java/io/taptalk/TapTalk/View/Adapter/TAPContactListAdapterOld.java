...
public class TAPContactListAdapterOld extends TAPBaseAdapter<TAPUserModel, TAPBaseViewHolder<TAPUserModel>> {
    ...
    public TAPContactListAdapterOld(int viewType, List<TAPUserModel> contactList) {
        setItems(contactList, false);
        this.viewType = viewType;
        this.myID = TAPChatManager.getInstance().getActiveUser().getUserID();
    }

    public TAPContactListAdapterOld(int viewType, List<TAPUserModel> contactList, @Nullable TapTalkContactListInterface listener) {
        setItems(contactList, false);
        this.viewType = viewType;
    ...
    public TAPContactListAdapterOld(List<TAPUserModel> contactList, List<TAPUserModel> selectedContacts, @Nullable TapTalkContactListInterface listener) {
        setItems(contactList, false);
