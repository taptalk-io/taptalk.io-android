...
class TapSharedMediaPagerAdapter(private val context : Context, private val instanceKey: String, fm: FragmentManager, private val room : TAPRoomModel?) : FragmentPagerAdapter(fm, BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT) {
