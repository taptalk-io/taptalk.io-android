...
public abstract class TAPChatRoomListener implements TapTalkChatRoomInterface {
    @Override
    ...
    @Override
    public void onTapTalkMessageQuoteTapped(Activity activity, TAPMessageModel messageModel, HashMap<String, Object> userInfo) {
    }
