package io.taptalk.TapTalk.Helper.CustomMaterialFilePicker.utils;
...
public class FileTypeUtils {
    public enum FileType {
        DIRECTORY(R.drawable.tap_cfp_ic_folder, R.string.tap_cfp_type_directory),
        DOCUMENT(R.drawable.tap_cfp_ic_document_box, R.string.tap_cfp_type_document),
        ...
        POWER_POINT(R.drawable.tap_cfp_ic_powerpoint_box, R.string.tap_cfp_type_power_point, "pptx", "keynote", "ppt", "pps", "pot", "odp", "otp"),
        WORD(R.drawable.tap_cfp_ic_word_box, R.string.tap_cfp_type_word, "doc", "docm", "docx", "dot", "mcw", "rtf", "pages", "odt", "ott"),
        ARCHIVE(R.drawable.tap_cfp_ic_zip_box, R.string.tap_cfp_type_archive, "cab", "7z", "alz", "arj", "bzip2", "bz2", "dmg", "gzip", "gz", "jar", "lz", "lzip", "lzma", "zip", "rar", "tar", "tgz"),
        APK(R.drawable.tap_cfp_ic_apk_box, R.string.tap_cfp_type_apk, "apk");
