...
public class TAPCustomTabHelper {
    ...
    public TAPCustomTabHelper() {
    }

    public static void addKeepAliveExtra(Context context, Intent intent) {
        String classCanonicalName = TAPKeepAliveService.class.getCanonicalName();
        if (null != classCanonicalName) {
            Intent keepAliveIntent = new Intent().setClassName(
                    context.getPackageName(), classCanonicalName);
    ...
    public static String getPackageNameToUse(Context context) {
        ...
        for (ResolveInfo info : resolvedActivityList) {
            ...
            if (null != pm.resolveService(serviceIntent, 0)) {
        ...
        } else if (1 == packagesSupportingCustomTabs.size()) {
