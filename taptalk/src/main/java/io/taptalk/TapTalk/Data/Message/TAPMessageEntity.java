...
public class TAPMessageEntity {
    ...
    public static TAPMessageEntity fromMessageModel(TAPMessageModel messageModel) {
        return new TAPMessageEntity(
            ...
            messageModel.getIsDelivered(),
            messageModel.getIsHidden(),
            messageModel.getIsMessageEdited(),
            messageModel.getIsDeleted(),
            messageModel.getIsSending(),
            messageModel.getIsFailedSend(),
            messageModel.getRoom().getRoomID(),
            messageModel.getRoom().getXcRoomID(),
            messageModel.getRoom().getName(),
            messageModel.getRoom().getColor(),
            messageModel.getRoom().getType(),
            null == messageModel.getRoom().getImageURL() ? null : TAPUtils.toJsonString(messageModel.getRoom().getImageURL()),
            messageModel.getRoom().isLocked(),
            messageModel.getRoom().isDeleted(),
            messageModel.getRoom().getLockedTime(),
            messageModel.getRoom().getDeleted(),
            messageModel.getUser().getUserID(),
            messageModel.getUser().getXcUserID(),
            messageModel.getUser().getFullname(),
            messageModel.getUser().getUsername(),
            null == messageModel.getUser().getImageURL() ? null : TAPUtils.toJsonString(messageModel.getUser().getImageURL()),
            messageModel.getUser().getEmail(), messageModel.getUser().getPhone(),
            null == messageModel.getUser().getUserRole() ? null : TAPUtils.toJsonString(messageModel.getUser().getUserRole()),
            messageModel.getUser().getLastLogin(),
            messageModel.getUser().getLastActivity(),
            messageModel.getUser().getRequireChangePassword(),
            messageModel.getUser().getCreated(),
            messageModel.getUser().getUpdated(),
            messageModel.getUser().getDeleted(),
            messageModel.getAction(),
            messageModel.getTarget()
        );
    }
