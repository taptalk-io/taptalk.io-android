...
public class TAPEncryptorManager {
    ...
    public String encrypt(String textToEncrypt, String id) throws GeneralSecurityException {
        ...
        try {
            ...
            encrypted = AESCrypt.encrypt(String.format("%s%s", TAPDefaultConstant.ENCRYPTION_KEY, localKey), textToEncrypt);
    ...
    public String decrypt(String textToDecrypt, String id) throws GeneralSecurityException {
        ...
        try {
            ...
            decrypted = AESCrypt.decrypt(String.format("%s%s", TAPDefaultConstant.ENCRYPTION_KEY, localKey), encrypted);
        } catch (Exception ex) {
            ex.printStackTrace();
            return "";
        }
