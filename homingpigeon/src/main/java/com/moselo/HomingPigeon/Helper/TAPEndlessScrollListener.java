...
public abstract class TAPEndlessScrollListener extends RecyclerView.OnScrollListener {
    ...
    public TAPEndlessScrollListener(LinearLayoutManager layoutManager) {
    ...
    public TAPEndlessScrollListener(GridLayoutManager layoutManager) {
        this.mLayoutManager = layoutManager;
        visibleThreshold = visibleThreshold * layoutManager.getSpanCount();
    }

    public TAPEndlessScrollListener(StaggeredGridLayoutManager layoutManager) {
        this.mLayoutManager = layoutManager;
        visibleThreshold = visibleThreshold * layoutManager.getSpanCount();
    }
