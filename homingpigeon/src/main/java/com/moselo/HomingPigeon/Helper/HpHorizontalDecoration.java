...
public class HpHorizontalDecoration extends RecyclerView.ItemDecoration {

    private int top, bottom, left, right, first, last, count;

    public HpHorizontalDecoration(int left, int right, int first, int last, int count, int top, int bottom) {
        this.left = left;
        this.right = right;
        this.first = first;
        this.last = last;
